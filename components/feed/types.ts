...
export type FeedItem = { id:string; postId:string; author:string; handle:string|null; text:string; url:string|null; postedAt:string|null; mediaUrl:string|null; bestAngle:string|null; lenses:string[]; wildcard:string|null; isFreshToday:boolean; metrics:{likes?:number; replies?:number; reposts?:number; views?:number} };
